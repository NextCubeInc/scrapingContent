-- Baseline: estado do schema public em 18/09/2026.
-- Timestamp casa com o registro ja existente em supabase_migrations.schema_migrations,
-- entao o remoto considera esta migration como JA APLICADA e nao reexecuta.
-- Serve para (a) destravar o deploy via GitHub e (b) recriar o schema num projeto novo.
